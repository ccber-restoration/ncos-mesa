...
upper <- read_xlsx("/Users/leeanderegg/Desktop/ongoing collabs/NCOS/uppersept425all.xlsx", sheet = 1, col_names = c("Timestamp",	"Port1_VWC",	"Port2_VWC",	"Port3_VWC",	"Port4_VWC",	"Port5_VWC",	"Port6_VWC",	"Bat_percent",	"mV.Battery.Voltage"),col_types = c("date","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric"), skip=3)
...
lower <- read_xlsx("/Users/leeanderegg/Desktop/ongoing collabs/NCOS/lowersept425all.xlsx", sheet = 1, col_names = c("Timestamp",	"Port1_VWC",	"Port2_VWC",	"Port3_VWC",	"Port4_VWC",	"Port5_VWC",	"Port6_VWC",	"Bat_percent",	"mV.Battery.Voltage"),col_types = c("date","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric"), skip=3)
